...
class Data_AL():
    def __init__(self):
        ...
        self.labeled_path, self.unlabeled_path = divide_trainset(self.unique_ids, self.all_imgs_path)


        self.trainset = AlMarket1501(train_transform, self.labeled_path, self.unique_ids)
        self.unlabeledset = AlMarket1501(train_transform, self.unlabeled_path, self.unique_ids)
        ...
        self.unlabeled_loader = dataloader.DataLoader(self.unlabeledset, batch_size=opt.batchtest,
